...
<div class=" flex md:w-full justify-between items-center border-b-[1px] border-accent-10 relative">
	...
	<div class="md:flex justify-between items-center w-full h-full relative hidden text-zinc-400">
		...
		<div class="flex justify-center items-center">
			<a href="/contacts" class="cursor-pointer border-l-[1px] border-accent-10">
				<p
					class="px-[31px] py-[16px] font-FiraCode hover:text-white text-base font-[450] not-italic"
					class:text-white={$page.url.pathname == '/contacts'}
				>
					_contact-me
				</p>
			</a>
...
{#if sidebarOpen}
	<div class="p-2 fixed z-50 left-0 top-0 right-0 bottom-0 w-full h-full bg-primary-bg">
		<div
			class=" border border-accent-10 w-full h-full bg-primary-bg rounded-lg flex flex-col justify-between items-stretch"
		...
		>
			...
			<div
				class="  border-t-[1px] border-accent-10 pl-[18px] flex relative justify-between items-center"
			>
				<div class="h-full">
					<p
						class="pt-[13px] pb-[15px] font-FiraCode text-base text-secondary not-italic font-[450]"
					>
						find me in :
					</p>
				</div>
				<div class="flex justify-end items-center h-full">
					<a
						...
						class="px-[16px] border-l-[1px] border-accent-10 h-full flex justify-center"
					>
						<img height="24px" width="24px" src={twitterSvg} alt="twitter" />
					</a>
					<a
						href="https://twitter.com/joyalDev"
						class="px-[16px] py-[16px] border-l-[1px] border-accent-10 h-full flex justify-center"
					>
